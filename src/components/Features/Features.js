...
const Features = () => {
   return (
      <div className='text-center my-16'>
         <h1 className='text-4xl'>Funfacts You Should Know</h1>
         <p className='my-6'>Lorem ipsum dolor sit amet consec tetur adipiscing elit sed do eius modatemp tempor sed magna aliqua elitar magna aliqua enim ad minim veniam magna.</p>
